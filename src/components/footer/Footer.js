      ...
      <div className="grid grid-cols-12">
        <div className="col-span-5">
          ...
          <div className="flex items-center justify-start mt-[24px]">
            <div>
              <BiSupport className="text-[#fed700] text-[65px]" />
            </div>
          ...
          <div className="flex items-center mt-[20px]">
            ...
            <BsPinterest className="text-[22px] text-[#848484] cursor-pointer ml-[32px] hover-iconSocial-pinterest" />
            <BsLinkedin className="text-[22px] text-[#848484] cursor-pointer ml-[32px] hover-iconSocial-linkedin" />
            <BsInstagram className="text-[22px] text-[#848484] cursor-pointer ml-[32px] hover-iconSocial-instagram" />
            <BsYoutube className="text-[22px] text-[#848484] cursor-pointer ml-[32px] hover-iconSocial-youtube" />
          </div>
        </div>
        <div className="col-span-7 footer-rightSide">
