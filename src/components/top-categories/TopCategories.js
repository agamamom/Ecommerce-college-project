          ...
          <div className="flex justify-between items-center w-[100%]">
            ...
            <div className="flex justify-center items-center flex-col h-full w-[50%]">
              ...
              <div className="flex items-center justify-start mt-[5px]">
                <span class="uppercase font-light block">
                  <span class="text-[.919em] leading-[.909em] inline-block w-[1.4em] mr-[4px] mb-[2px]">
                    Up
                    <br />
                    to
                  </span>
                  <span class="font-bold text-[2.173em] tracking-tight">
                    70
                  </span>
                  <span class="-top-[0.5em] relative font-bold align-top ml-[2px]">
                    %
                  </span>
                </span>
                <IoIosArrowDroprightCircle className="text-[22px] text-[#fed400] ml-[10px]" />
