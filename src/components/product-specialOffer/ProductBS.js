               ...
               <div className="mb-[10px] w-full relative">
                  {product && (
                     <img
                        ...
                        className="w-[100px] h-[100px] m-auto align-middle"
                        alt=""
                        loading="lazy"
                     />
                  )}
            ...
            <div className="min-w-[180px]">
               <span className="mb-[12px] text-[12px] leading-[13px] h-[13px]">
                  <a
                     href="/"
                     rel="tag"
                     className="text-[#768b9e] whitespace-nowrap"
                  >
                     {result.substring(0, 25)}
                  </a>
               </span>
               <a href="/" className="block">
                  <h2 className="text-[14px] leading-[18px] h-[36px] font-bold text-[#0062bd] mt-[14px]">
                     {product &&
