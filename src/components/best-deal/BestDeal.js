   ...
   return (
      <div className="bg-[#f4f4f4] mt-[40px]">
         <div className="px-[45px] pt-[15px] pb-[30px]">
            <ul className="text-[15px] mb-[15px] border-b-[1px] border-b-[#ddd] leading-[38px] whitespace-nowrap justify-center flex flex-wrap list-none">
               <li className="BestDeal-nav-item mr-[22px]">
                  <div className="active BestDeal-nav-link active">
                  ...
                  <div className="px-[24px] pt-[14px] pb-[14px] relative product-inner">
                     <div className="relative">
                        ...
                        <a href="/" className="block">
                           ...
                           <div className="my-[40px] w-full relative">
                              <img
                                 width="300"
                                 height="300"
                                 src="https://electro.madrasthemes.com/wp-content/uploads/2016/03/consal.png"
                                 className="max-w-[100%] max-h-[100%] w-auto h-auto m-auto align-middle"
                                 alt=""
                                 loading="lazy"
                              />
                           </div>
