         ...
         <div key={i}>
            <div className="flex items-center">
               <div className="product-image">
                  <div className="w-[64px] h-[64px] rounded-[8px] bg-white relative">
                     ...
                     <span
                        className="product-thumbnail-quantity text-[12px] font-medium whitespace-nowrap py-[1.8px] px-[7.8px] rounded-[2em] bg-[#999999e6] text-white absolute -right-[9px] -top-[9px] z-[3]"
                        aria-hidden="true"
                     >
                        {p.count}
                     </span>
   ...
   return (
      <div className="row w-[90%] my-0 mx-auto h-[100vh]">
         ...
         <div className="col-md-6 mt-[40px] pr-[130px] h-[100%] pl-[4%]">
            ...
            <hr />
            <p className="pt-[15px] tex-[20px] font-bold">
               Cart Total: {USDPrice}
            </p>
